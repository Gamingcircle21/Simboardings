...
══════════════════════════════════════ */
const AP = [
  { code: "EGLL", name: "Heathrow", city: "London" },
  { code: "EGKK", name: "Gatwick", city: "London" },
  { code: "EGSS", name: "Stansted", city: "London" },
  { code: "EGCC", name: "Manchester", city: "Manchester" },
  { code: "EGBB", name: "Birmingham", city: "Birmingham" },
  { code: "EGPH", name: "Edinburgh", city: "Edinburgh" },
  { code: "EGPF", name: "Glasgow", city: "Glasgow" },
  { code: "EIDW", name: "Dublin", city: "Dublin" },
  { code: "EINN", name: "Shannon", city: "Shannon" },
  { code: "EICK", name: "Cork", city: "Cork" },
  { code: "LFPG", name: "Charles de Gaulle", city: "Paris" },
  { code: "LFPO", name: "Orly", city: "Paris" },
  { code: "LFMN", name: "Nice Côte d'Azur", city: "Nice" },
  { code: "LFML", name: "Provence", city: "Marseille" },
  { code: "EDDF", name: "Frankfurt", city: "Frankfurt" },
  { code: "EDDM", name: "Munich", city: "Munich" },
  { code: "EDDB", name: "Brandenburg", city: "Berlin" },
  { code: "EDDH", name: "Hamburg", city: "Hamburg" },
  { code: "EDDL", name: "Düsseldorf", city: "Düsseldorf" },
  { code: "EDDK", name: "Cologne Bonn", city: "Cologne" },
  { code: "EHAM", name: "Schiphol", city: "Amsterdam" },
  { code: "EBBR", name: "Brussels", city: "Brussels" },
  { code: "LEMD", name: "Barajas", city: "Madrid" },
  { code: "LEBL", name: "El Prat", city: "Barcelona" },
  { code: "LEMG", name: "Costa del Sol", city: "Malaga" },
  { code: "LEPA", name: "Palma", city: "Palma de Mallorca" },
  { code: "GCLP", name: "Gran Canaria", city: "Las Palmas" },
  { code: "GCTS", name: "Tenerife South", city: "Tenerife" },
  { code: "LPPT", name: "Humberto Delgado", city: "Lisbon" },
  { code: "LPPR", name: "Francisco Sá Carneiro", city: "Porto" },
  { code: "LPFR", name: "Faro", city: "Faro" },
  { code: "LSZH", name: "Zürich", city: "Zürich" },
  { code: "LSGG", name: "Cointrin", city: "Geneva" },
  { code: "LOWW", name: "Vienna", city: "Vienna" },
  { code: "LOWI", name: "Innsbruck", city: "Innsbruck" },
  { code: "LKPR", name: "Václav Havel", city: "Prague" },
  { code: "EPWA", name: "Chopin", city: "Warsaw" },
  { code: "EPKK", name: "Kraków", city: "Kraków" },
  { code: "LHBP", name: "Budapest Ferenc Liszt", city: "Budapest" },
  { code: "LROP", name: "Henri Coandă", city: "Bucharest" },
  { code: "LYBE", name: "Nikola Tesla", city: "Belgrade" },
  { code: "LGAV", name: "Eleftherios Venizelos", city: "Athens" },
  { code: "LCLK", name: "Larnaca", city: "Larnaca" },
  { code: "LIRF", name: "Fiumicino", city: "Rome" },
  { code: "LIMC", name: "Malpensa", city: "Milan" },
  { code: "LIME", name: "Orio al Serio", city: "Bergamo" },
  { code: "LIPZ", name: "Marco Polo", city: "Venice" },
  { code: "EKCH", name: "Kastrup", city: "Copenhagen" },
  { code: "ENGM", name: "Gardermoen", city: "Oslo" },
  { code: "ENBR", name: "Flesland", city: "Bergen" },
  { code: "EFHK", name: "Vantaa", city: "Helsinki" },
  { code: "ESGG", name: "Landvetter", city: "Gothenburg" },
  { code: "ESSA", name: "Arlanda", city: "Stockholm" },
  { code: "BIIS", name: "Keflavík", city: "Reykjavík" },
  { code: "EVRA", name: "Riga", city: "Riga" },
  { code: "EYVI", name: "Vilnius", city: "Vilnius" },
  { code: "EETN", name: "Lennart Meri", city: "Tallinn" },
  { code: "UUEE", name: "Sheremetyevo", city: "Moscow" },
  { code: "ULLI", name: "Pulkovo", city: "St. Petersburg" },
  { code: "UKBB", name: "Boryspil", city: "Kyiv" },
  { code: "LTFM", name: "Istanbul Airport", city: "Istanbul" },
  { code: "LTAI", name: "Antalya", city: "Antalya" },
  { code: "LTBJ", name: "Adnan Menderes", city: "İzmir" },
  { code: "UDYZ", name: "Zvartnots", city: "Yerevan" },
  { code: "UBBB", name: "Heydar Aliyev", city: "Baku" },
  { code: "UGTB", name: "Tbilisi", city: "Tbilisi" },
  { code: "OMDB", name: "Dubai Int'l", city: "Dubai" },
  { code: "OMDW", name: "Al Maktoum", city: "Dubai" },
  { code: "OMAA", name: "Zayed Int'l", city: "Abu Dhabi" },
  { code: "OTHH", name: "Hamad Int'l", city: "Doha" },
  { code: "OBBI", name: "Bahrain Int'l", city: "Manama" },
  { code: "OKBK", name: "Kuwait Int'l", city: "Kuwait City" },
  { code: "OOMS", name: "Muscat Int'l", city: "Muscat" },
  { code: "OEJN", name: "King Abdulaziz", city: "Jeddah" },
  { code: "OERK", name: "King Khalid", city: "Riyadh" },
  { code: "OEDF", name: "King Fahd", city: "Dammam" },
  { code: "OLBA", name: "Rafic Hariri", city: "Beirut" },
  { code: "OJAI", name: "Queen Alia", city: "Amman" },
  { code: "LL_bg", name: "Ben Gurion", city: "Tel Aviv" },
  { code: "VIDP", name: "Indira Gandhi", city: "Delhi" },
  { code: "VABB", name: "Chhatrapati Shivaji", city: "Mumbai" },
  { code: "VOBL", name: "Kempegowda", city: "Bengaluru" },
  { code: "VOMM", name: "Chennai", city: "Chennai" },
  { code: "VOCC", name: "Cochin", city: "Kochi" },
  { code: "VOGO", name: "Goa", city: "Goa" },
  { code: "VECC", name: "Netaji S.C. Bose", city: "Kolkata" },
  { code: "VIAH", name: "Rajiv Gandhi", city: "Hyderabad" },
  { code: "OPKC", name: "Jinnah", city: "Karachi" },
  { code: "OPLA", name: "Allama Iqbal", city: "Lahore" },
  { code: "OPIS", name: "Islamabad", city: "Islamabad" },
  { code: "OPPW", name: "Peshawar", city: "Peshawar" },
  { code: "OPQT", name: "Quetta", city: "Quetta" },
  { code: "OPMT", name: "Multan", city: "Multan" },
  { code: "VRMM", name: "Velana", city: "Malé" },
  { code: "VCBI", name: "Bandaranaike", city: "Colombo" },
  { code: "VGZR", name: "Shahjalal", city: "Dhaka" },
  { code: "VNKT", name: "Tribhuvan", city: "Kathmandu" },
  { code: "WSSS", name: "Changi", city: "Singapore" },
  { code: "WMKK", name: "KLIA", city: "Kuala Lumpur" },
  { code: "WMKP", name: "Penang", city: "Penang" },
  { code: "WBKK", name: "Kota Kinabalu", city: "Kota Kinabalu" },
  { code: "VTBS", name: "Suvarnabhumi", city: "Bangkok" },
  { code: "VTBD", name: "Don Mueang", city: "Bangkok" },
  { code: "VTSP", name: "Phuket", city: "Phuket" },
  { code: "VTCC", name: "Chiang Mai", city: "Chiang Mai" },
  { code: "VVTS", name: "Tan Son Nhat", city: "Ho Chi Minh City" },
  { code: "VVNB", name: "Noi Bai", city: "Hanoi" },
  { code: "VVDN", name: "Da Nang", city: "Da Nang" },
  { code: "WIII", name: "Soekarno-Hatta", city: "Jakarta" },
  { code: "WADD", name: "Ngurah Rai", city: "Bali" },
  { code: "RPLL", name: "Ninoy Aquino", city: "Manila" },
  { code: "RPVM", name: "Mactan-Cebu", city: "Cebu" },
  { code: "VDPP", name: "Phnom Penh", city: "Phnom Penh" },
  { code: "VYYY", name: "Yangon", city: "Yangon" },
  { code: "RJAA", name: "Narita", city: "Tokyo" },
  { code: "RJTT", name: "Haneda", city: "Tokyo" },
  { code: "RJBB", name: "Kansai", city: "Osaka" },
  { code: "RJCC", name: "New Chitose", city: "Sapporo" },
  { code: "RJFF", name: "Fukuoka", city: "Fukuoka" },
  { code: "RJNN", name: "Chubu Centrair", city: "Nagoya" },
  { code: "RKSI", name: "Incheon", city: "Seoul" },
  { code: "RKSS", name: "Gimpo", city: "Seoul" },
  { code: "RKPK", name: "Gimhae", city: "Busan" },
  { code: "RCTP", name: "Taoyuan", city: "Taipei" },
  { code: "RCSS", name: "Songshan", city: "Taipei" },
  { code: "VHHH", name: "Hong Kong Int'l", city: "Hong Kong" },
  { code: "VMMC", name: "Macau", city: "Macau" },
  { code: "ZBAA", name: "Capital", city: "Beijing" },
  { code: "ZBAD", name: "Daxing", city: "Beijing" },
  { code: "ZSPD", name: "Pudong", city: "Shanghai" },
  { code: "ZSSS", name: "Hongqiao", city: "Shanghai" },
  { code: "ZGGG", name: "Baiyun", city: "Guangzhou" },
  { code: "ZGSZ", name: "Bao'an", city: "Shenzhen" },
  { code: "ZUUU", name: "Tianfu", city: "Chengdu" },
  { code: "ZPPP", name: "Changshui", city: "Kunming" },
  { code: "ZLXY", name: "Xianyang", city: "Xi'an" },
  { code: "UAAA", name: "Almaty", city: "Almaty" },
  { code: "UACC", name: "Nursultan", city: "Astana" },
  { code: "UTTT", name: "Tashkent", city: "Tashkent" },
  { code: "UAFM", name: "Manas", city: "Bishkek" },
  { code: "HECA", name: "Cairo", city: "Cairo" },
  { code: "HAAB", name: "Bole", city: "Addis Ababa" },
  { code: "HKJK", name: "Jomo Kenyatta", city: "Nairobi" },
  { code: "HTDA", name: "Julius Nyerere", city: "Dar es Salaam" },
  { code: "HRYR", name: "Kigali", city: "Kigali" },
  { code: "HUQI", name: "Entebbe", city: "Entebbe" },
  { code: "DTTA", name: "Tunis-Carthage", city: "Tunis" },
  { code: "DAAG", name: "Houari Boumediene", city: "Algiers" },
  { code: "GMME", name: "Mohammed V", city: "Casablanca" },
  { code: "GMMX", name: "Marrakech", city: "Marrakech" },
  { code: "FAOR", name: "OR Tambo", city: "Johannesburg" },
  { code: "FACT", name: "Cape Town", city: "Cape Town" },
  { code: "FALE", name: "King Shaka", city: "Durban" },
  { code: "DNMM", name: "Murtala Muhammed", city: "Lagos" },
  { code: "DNAM", name: "Nnamdi Azikiwe", city: "Abuja" },
  { code: "DIAP", name: "Félix-Houphouët-Boigny", city: "Abidjan" },
  { code: "GOBD", name: "Blaise Diagne", city: "Dakar" },
  { code: "FOOL", name: "Léon-Mba", city: "Libreville" },
  { code: "FMMI", name: "Ivato", city: "Antananarivo" },
  { code: "FIMP", name: "Sir S. Ramgoolam", city: "Mauritius" },
  { code: "FSSS", name: "Seychelles", city: "Mahé" },
  { code: "KJFK", name: "JFK", city: "New York" },
  { code: "KLGA", name: "LaGuardia", city: "New York" },
  { code: "KEWR", name: "Newark Liberty", city: "New York" },
  { code: "KBOS", name: "Logan", city: "Boston" },
  { code: "KPHL", name: "Philadelphia", city: "Philadelphia" },
  { code: "KIAD", name: "Dulles", city: "Washington DC" },
  { code: "KDCA", name: "Reagan National", city: "Washington DC" },
  { code: "KATL", name: "Hartsfield-Jackson", city: "Atlanta" },
  { code: "KMCO", name: "Orlando", city: "Orlando" },
  { code: "KMIA", name: "Miami Int'l", city: "Miami" },
  { code: "KFLL", name: "Fort Lauderdale", city: "Fort Lauderdale" },
  { code: "KTPA", name: "Tampa", city: "Tampa" },
  { code: "KORD", name: "O'Hare", city: "Chicago" },
  { code: "KMDW", name: "Midway", city: "Chicago" },
  { code: "KDTW", name: "Metropolitan Wayne County", city: "Detroit" },
  { code: "KMSP", name: "Minneapolis-St. Paul", city: "Minneapolis" },
  { code: "KSTL", name: "Lambert-St. Louis", city: "St. Louis" },
  { code: "KMCI", name: "Kansas City", city: "Kansas City" },
  { code: "KDEN", name: "Denver", city: "Denver" },
  { code: "KSLC", name: "Salt Lake City", city: "Salt Lake City" },
  { code: "KDFW", name: "Dallas Fort Worth", city: "Dallas" },
  { code: "KAUS", name: "Austin-Bergstrom", city: "Austin" },
  { code: "KIAH", name: "George Bush", city: "Houston" },
  { code: "KMSY", name: "Louis Armstrong", city: "New Orleans" },
  { code: "KSAN", name: "San Diego", city: "San Diego" },
  { code: "KLAX", name: "LAX", city: "Los Angeles" },
  { code: "KSFO", name: "SFO", city: "San Francisco" },
  { code: "KOAK", name: "Oakland", city: "Oakland" },
  { code: "KSJC", name: "San Jose", city: "San Jose" },
  { code: "KPDX", name: "Portland", city: "Portland" },
  { code: "KSEA", name: "Seattle-Tacoma", city: "Seattle" },
  { code: "KPHX", name: "Phoenix Sky Harbor", city: "Phoenix" },
  { code: "KLAS", name: "Harry Reid", city: "Las Vegas" },
  { code: "PANC", name: "Ted Stevens", city: "Anchorage" },
  { code: "PHNL", name: "Daniel K. Inouye", city: "Honolulu" },
  { code: "KCLT", name: "Charlotte Douglas", city: "Charlotte" },
  { code: "KRDU", name: "Raleigh-Durham", city: "Raleigh" },
  { code: "KIND", name: "Indianapolis", city: "Indianapolis" },
  { code: "KCMH", name: "John Glenn", city: "Columbus" },
  { code: "KBNA", name: "Nashville", city: "Nashville" },
  { code: "KMEM", name: "Memphis", city: "Memphis" },
  { code: "CYYZ", name: "Pearson", city: "Toronto" },
  { code: "CYVR", name: "Vancouver", city: "Vancouver" },
  { code: "CYYC", name: "Calgary", city: "Calgary" },
  { code: "CYEG", name: "Edmonton", city: "Edmonton" },
  { code: "CYUL", name: "Trudeau", city: "Montréal" },
  { code: "CYOW", name: "MacDonald-Cartier", city: "Ottawa" },
  { code: "CYHZ", name: "Stanfield", city: "Halifax" },
  { code: "MMMX", name: "Benito Juárez", city: "Mexico City" },
  { code: "MMUN", name: "Cancún", city: "Cancún" },
  { code: "MMGL", name: "Don Miguel Hidalgo", city: "Guadalajara" },
  { code: "MROC", name: "Juan Santamaría", city: "San José" },
  { code: "MPTO", name: "Tocumen", city: "Panama City" },
  { code: "MUHA", name: "José Martí", city: "Havana" },
  { code: "MDSD", name: "Las Américas", city: "Santo Domingo" },
  { code: "TJSJ", name: "Luis Muñoz Marín", city: "San Juan" },
  { code: "S_bgR", name: "Guarulhos", city: "São Paulo" },
  { code: "SBBR", name: "Juscelino Kubitschek", city: "Brasília" },
  { code: "S_bgL", name: "Galeão", city: "Rio de Janeiro" },
  { code: "SBPA", name: "Salgado Filho", city: "Porto Alegre" },
  { code: "SCEL", name: "Arturo Merino Benítez", city: "Santiago" },
  { code: "SEQM", name: "Mariscal Sucre", city: "Quito" },
  { code: "SEGU", name: "José Joaquín de Olmedo", city: "Guayaquil" },
  { code: "SKBO", name: "El Dorado", city: "Bogotá" },
  { code: "SPJC", name: "Jorge Chávez", city: "Lima" },
  { code: "SVMI", name: "Simón Bolívar", city: "Caracas" },
  { code: "SAEZ", name: "Ministro Pistarini", city: "Buenos Aires" },
  { code: "YSSY", name: "Kingsford Smith", city: "Sydney" },
  { code: "YMLB", name: "Melbourne", city: "Melbourne" },
  { code: "YBBN", name: "Brisbane", city: "Brisbane" },
  { code: "YPPH", name: "Perth", city: "Perth" },
  { code: "YPAD", name: "Adelaide", city: "Adelaide" },
  { code: "NZAA", name: "Auckland", city: "Auckland" },
  { code: "NZCH", name: "Christchurch", city: "Christchurch" },
  { code: "NZWN", name: "Wellington", city: "Wellington" },
  { code: "NZQN", name: "Queenstown", city: "Queenstown" },
  { code: "NFFN", name: "Nadi", city: "Nadi" },
  { code: "PGUM", name: "Antonio B. Won Pat", city: "Guam" }
];
